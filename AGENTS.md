...
> Repository development instructions for **omnimail** (Next.js Project).
...
Omnixys Omnimail frontend (Next.js 16, MUI, Apollo + codegen, TanStack Query, Zustand, next-intl).

- Repository path: `projects/omnimail` (relative to the Omnixys root)
...
src/app (App Router), src/api, src/assets, src/auth, src/components, src/constants, src/generated, src/hooks, src/lib
...
Keep the generated `<!-- BEGIN:nextjs-agent-rules -->` block in AGENTS.md intact. Do not manually edit generated code.
